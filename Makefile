...
# Template: app
# Command: C:/Qt/Static/5.3.2/bin/qmake.exe -spec win32-g++ CONFIG+=release -o Makefile ConvertText.pro
#############################################################################
...
Makefile: ConvertText.pro C:/Qt/Static/5.3.2/mkspecs/win32-g++/qmake.conf C:/Qt/Static/5.3.2/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ CONFIG+=release -o Makefile ConvertText.pro
...
distclean: release-distclean debug-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) H:/WORKSPACE/Qt/ConvertText/converttext_plugin_import.cpp
